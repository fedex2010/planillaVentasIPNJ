...
import warning from '../images/error/warning.svg'
    ...
    return(
        ...
        <div className={classes.mainContainer}>  
            <section className={classes.containerData}>  
                <img src={warning} className={classes.warning}/>
                
                <section className={classes.mainText} >Ya sos cliente</section>
                
                <section className={classes.secondaryText}>Para sacar tu tarjeta, acercate a una de nuestras sucursales.</section>
...
export default ErrorYaEsCliente